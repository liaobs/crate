...
public class StatsTables {
    ...
    protected final AtomicReference<Queue<JobContextLog>> jobsLog = new AtomicReference<>();
    protected final AtomicReference<Queue<OperationContextLog>> operationsLog = new AtomicReference<>();
